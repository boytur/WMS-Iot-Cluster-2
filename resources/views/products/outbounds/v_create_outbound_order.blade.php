                                ...
                                <tbody>
                                    @foreach ($master_products as $index => $master_product)
                                        <tr class="bg-white border-b  hover:bg-blue-100 cursor-pointer ">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                ...
                                                <div class="flex justify-center items-center">
                                                    <a href="javascript:void(0)"
                                                        class="bg-slate-400 rounded-l-lg hover:bg-slate-500"
                                                        onclick="decreaseQuantity(this)"><i
                                                            class="fa-solid fa-minus p-1.5"></i></a>
                                                    <div
                                                        class="pl-2 pr-2 pt-[2px] pb-[2.5px] bg-white border border-slate-400">
                                                        <p class="quantity"> 0 </p>
                                                    </div>
                                                    <a href="javascript:void(0)"
                                                        class="bg-slate-400 rounded-r-lg hover:bg-slate-500"
                                                        onclick="increaseQuantity(this)"><i
                                                            class="fa-solid fa-plus p-1.5"></i></a>
                                                </div>
                                            </td>
                                            <script>
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <a><i
                                                        class="fa-solid fa-circle-plus text-green-500 text-lg hover:text-green-600 hover:text-[1.5em]"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
