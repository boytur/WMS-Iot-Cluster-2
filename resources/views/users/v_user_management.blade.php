                        ...
                        <div class="w-3/4 flex gap-2 h-full">
                            <div class="w-full">
                                <div>
                                    ...
                                    <input onfocus="handle_search()" type="text" placeholder="กรอกรายละเอียดที่ต้องการค้นหา..." class="input-primary h-[3rem]" name="user_search" id="user_search">
                                </div>
                            </div>
                            <div class="md:w-[15rem]">
                                <div>
                                    <p class="text-black/70 text-sm">ค้นหาด้วย</p>
                                    <select name="user_attribute" id="user_attribute" class="w-full h-[3rem] input-primary px-2 cursor-pointer">
                            ...
                            <div class="md:w-[10rem] h-full mt-5">
                                <div class="w-full">
                                    <button onclick="handle_search()" class="w-full h-[3rem] gap-2 btn-primary flex items-center justify-center mx-2">
                                        <div>
                ...
                {{-- ช่องกรอกข้อมูล --}}
                    <div class="w-2/3 border rounded-lg p-3 ">
                        ...
                        <div class="mb-4 px-1 w-full">
                            ...
                            <input type="text" id="name" name="name" placeholder="กรอกนามสกุลตรงนี้..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5" required>
                        </div>
